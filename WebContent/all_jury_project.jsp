    ...
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock> <p style="text-align:center;font-size:20px;">已为项目分配评审员信息列表</p> </xblock>
            <table class="layui-table">
                ...
                <tbody>
                  <c:forEach items="${alljury}" var="jury">
                <tr >
					<td>${jury.adju_id}</td>
					<td>${jury.adju_name}</td>
					<td>${jury.student_id}</td>
					<td>${jury.student_name}</td>
					<td>${jury.project_id}</td>
					<td>${jury.project_name}</td>
					 <td class="td-manage">
                            <a title="删除" href="deletejuryproject.do?judge_id=${jury.judge_id}&username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>" 
