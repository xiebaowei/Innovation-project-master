...
<body>
    ...
    <div class="wrapper">
        ...
        <form class="layui-form xbs" action="" >
           ...
           <xblock><button class="layui-btn"><a  href="${pageContext.request.contextPath }/teacher_add_project.jsp?username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %> ">添加项目</a></button> </xblock>
		   <xblock><p style="text-align:center;font-size:20px;">你已创建的项目信息如下</p></xblock> 
            <table class="layui-table">
                ...
                <tbody>
                    <c:forEach items="${Teaproject}" var="project">
                <tr >
					<td>${project.project_id}</td>
					<td>${project.project_name}</td>
				    <td>${project.project_info}</td>
					<td class="td-manage">
                            <a title="删除" href="deleteproject.do?project_id=${project.project_id}&username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>" 
