    ...
    <div class="wrapper">
		...
		<div class="page-content">
          <div class="content">
            ...
            <xblock> <p style="text-align:center;font-size:20px;">你可以申报的项目信息如下</p> </xblock>
            <table class="layui-table">
                ...
                <tr >
					...
					<td>${project.teacher_id}</td>
					<td>${project.teacher_name}</td>
					<td>${project.project_info}</td>
					<td class="td-manage">
                        
                            <a title="申报" href="${pageContext.request.contextPath }/student_project_edit.jsp?username=<%=request.getParameter("username") %>&teacher_id=${project.teacher_id}&project_id=${project.project_id}&name=<%=request.getParameter("name") %>" 
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                           <a title="下载" href="${pageContext.request.contextPath }/project_download?project_id=${project.project_id}" 
