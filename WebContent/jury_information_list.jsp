    ...
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock><button class="layui-btn" ><a  href=" jury_information_add.jsp?username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>"   >添加评审员信息</a></button></xblock>
            <table class="layui-table">
				...
				<td class="td-manage">
                            <a title="删除" href="deletejury.do?jury_id=${jury.adjudicator_id}&username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>" 
