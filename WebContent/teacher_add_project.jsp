...
<!-- 顶部开始 -->
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form"   action="${pageContext.request.contextPath }/addproject.do?username<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>">
             <div class="layui-form-item">
             <input type="hidden" id="L_username" name="username" required="" value ="<%=request.getParameter("username") %>"lay-verify="nikename"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_username" name="projectid" required="" lay-verify="nikename"
                        autocomplete="off" class="layui-input">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_college" name="project_name" required="" lay-verify="college"
                        autocomplete="off" class="layui-input">
				 ...
				 <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="随便写些什么刷下存在感" id="L_sign" name="project_info" required="" autocomplete="off"
