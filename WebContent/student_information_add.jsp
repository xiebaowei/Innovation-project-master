...
<!-- 顶部开始 -->
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form" method="post" action="${pageContext.request.contextPath }/studentadd.do?name=<%=request.getParameter("name") %>&username=<%=request.getParameter("username") %>">
				...
				<div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            <input type="radio" name="student_sex" value="男" checked title="男">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="student_college" name="student_college" required=""
                        class="layui-input">
                    </div>
                </div>
				<div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="student_phonenumber" name="student_phonenumber" required="" lay-verify="number"
                         class="layui-input">
                    </div>
