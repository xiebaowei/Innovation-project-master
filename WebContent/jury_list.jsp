    ...
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock><button class="layui-btn"><a  href="${pageContext.request.contextPath }/jury_edit.jsp?username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>">修改个人信息</a></button></xblock>
            <table class="layui-table">
                ...
                <tbody>
                  <c:forEach items="${AdjuList}" var="adju">
                <tr >
					<td>${adju.adjudicator_id}</td>
					<td>${adju.adjudicator_name}</td>
