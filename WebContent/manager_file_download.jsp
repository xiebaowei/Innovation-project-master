    ...
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock> <p style="text-align:center;font-size:20px;">请下载相关文档</p> </xblock>
            <table class="layui-table">
                ...
                <tr >
					...
					<td class="td-manage">
                           ...
                           <a title="下载" href="${pageContext.request.contextPath }/managerdownload.do?file_id=${file.file_id}&username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>" 
