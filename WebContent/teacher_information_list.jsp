    ...
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock> <button class="layui-btn"> <a  href=" ${pageContext.request.contextPath }/teacher_information_add.jsp?username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>"   >添加教师信息</a></button></xblock>
            <table class="layui-table">
                ...
                <tr >
					...
					<td>${tea.teacher_college}</td>
					<td>${tea.teacher_phonenumber}</td>
					<td class="td-manage">
                            <a title="删除" href="deleteteacher.do?teacher_id=${tea.teacher_id}&username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>" 
