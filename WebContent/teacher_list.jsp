    ...
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock><button class="layui-btn" ><a  href="${pageContext.request.contextPath }/teacher_edit.jsp?name=<%=request.getParameter("name") %>&username=<%=request.getParameter("username") %>">修改个人信息</a></button></xblock>
            <table class="layui-table">
                ...
                <tr >
					...
					<td>${teacher.teacher_college}</td>
					<td>${teacher.teacher_phonenumber}</td>
				</tr>
                </c:forEach>
