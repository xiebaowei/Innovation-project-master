    ...
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock><button class="layui-btn" > <a  href=" student_information_add.jsp?username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>"   >添加学生信息</a></button></xblock>
            <table class="layui-table">
                ...
                <tr >
					...
					<td>${stu.student_college}</td>
					<td>${stu.student_phonenumber}</td>
					<td class="td-manage">
                            <a title="删除" href="deletestudent.do?student_id=${stu.student_id}&username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>" 
