...
<body>
    ...
    <div class="wrapper">
		...
		<div class="page-content">
          <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
    <form class="layui-form xbs" action=" ${pageContext.request.contextPath }/serch.do?username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>" >
                <div class="layui-form-pane" style="text-align: center;">
                  <div class="layui-form-item" style="display: inline-block;">
                    ...
                    <div class="layui-input-inline">
					 ...
					 <div class="layui-input-inline">
                      <input type="text" name="projectid"  placeholder="请输入项目名" autocomplete="off" class="layui-input">
                    </div>
					
					 <div class="layui-input-inline">
                      <input type="text" name="teacherid"  placeholder="请输入教师编号" autocomplete="off" class="layui-input">
                    </div>
					 <div class="layui-input-inline">
                      <input type="text" name="teachername"  placeholder="请输入教师姓名" autocomplete="off" class="layui-input">
                    </div>
            ...
            <xblock> <p style="text-align:center;font-size:20px;">全部申报项目信息如下(点击审核通过可设置项目通过)</p> </xblock>
            <table class="layui-table">
                ...
                <tbody>
                 ...
                 <c:forEach items="${ApplyList}" var="applystu">
                <tr >
				...
				<td class="td-manage">
                            ...
                            <a title="审核通过" href="${pageContext.request.contextPath }/auditproject.do?student_id=${applystu.student_id}&username=<%=request.getParameter("username") %>&name=<%=request.getParameter("name") %>" 
